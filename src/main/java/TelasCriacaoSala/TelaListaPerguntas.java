...
public class TelaListaPerguntas extends JFrame {
    ...
    public static class PanelListaPerguntas extends JPanel {
        ...
        private boolean mostrarImagemBotaoMedio = false;
        private boolean mostrarImagemBotaoDificil = true;
            ...
            JPanel painelConteudo = new JPanel(null) {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    if (mostrarImagemBotaoFacil) {
                        g2d.drawImage(imagemBotaoFacil, xFacil, yFacil, larguraBotFacil, alturaBotFacil, this);
                    }
                    if (mostrarImagemBotaoMedio) {
                        g2d.drawImage(imagemBotaoMedio, xMedio, yMedio, larguraBotMedio, alturaBotMedio, this);
                    }
                    if (mostrarImagemBotaoDificil) {
                        g2d.drawImage(imagemBotaoDificil, xDificil, yDificil, larguraBotDificil, alturaBotDificil, this);
                    }
