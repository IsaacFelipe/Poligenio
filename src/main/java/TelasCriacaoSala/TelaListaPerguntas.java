...
/*-------------------------CONFIGURAÇÕES DA JANELA----------------------------*/
        ...
        painelListaPerguntas = new JPanel();
...
/*-------------------------CARREGAMENTO DAS IMAGENS---------------------------*/
        ...
        ("/ImagensTelaListaPerguntas/telaListaPerguntas.png"));
            ...
            imagemBoxQuest = ImageIO.read(getClass().getResource
        ("/ImagensTelaListaPerguntas/boxPerguntaEditar.png"));
            
            imagemBotaoFacil = ImageIO.read(getClass().getResource
        ("/ImagensTelaListaPerguntas/botaoFacil.png"));
            
            imagemBotaoMedio = ImageIO.read(getClass().getResource
        ("/ImagensTelaListaPerguntas/botaoMedio.png"));
            
            imagemBotaoDificil = ImageIO.read(getClass().getResource
        ("/ImagensTelaListaPerguntas/botaoDificil.png"));
            
            imagemBotaoDificuldade = ImageIO.read(getClass().getResource
        ("/ImagensTelaListaPerguntas/botaoDificuldade.png"));
            
            imagemBotaoEditarPergunta = ImageIO.read(getClass().getResource
        ("/ImagensTelaListaPerguntas/botaoEditarPergunta.png"));
...
/*----------------------DIMENSIONAMENTO E POSICIONAMENTO----------------------*/
                    ...
                    int alturaBoxQuest = (int) 
                            (imagemBoxQuest.getHeight() * 0.7 * escala);
                    
                    int larguraBotFacil = (int) 
                            (imagemBotaoFacil.getWidth() * 0.7 * escala);
                    int alturaBotFacil = (int)
                            (imagemBotaoFacil.getHeight() * 0.7 * escala);
                    
                    int larguraBotMedio = (int)
                            (imagemBotaoMedio.getWidth() * 0.7 * escala);
                    int alturaBotMedio = (int) 
                            (imagemBotaoMedio.getHeight() * 0.7 * escala);
                    
                    int larguraBotDificil = (int) 
                            (imagemBotaoDificil.getWidth() * 0.7 * escala);
                    int alturaBotDificil = (int) 
                            (imagemBotaoDificil.getHeight() * 0.7 * escala);
                    
                    int larguraBotDif = (int) 
                            (imagemBotaoDificuldade.getWidth() * 0.7 * escala);
                    int alturaBotDif = (int)
...
/*------------------------POSICIONAMENTO DOS CAMPOS---------------------------*/
                    ...
                    botaoEditarPergunta.setBounds(xEditar,
                            yEditar, 
                            larguraBotEditar, 
                            alturaBotEditar);
                    
                    campoTextoPergunta.setBounds(xBoxQuest + (int)(82 * escala),
                            yBoxQuest + (int)(1 * escala), 
                            (int)(250 * escala), (int)(50 * escala));
                    
                    campoTextoNumeroPergunta.setBounds(xBoxQuest - 
                            (int)(50 * escala), 
                            yBoxQuest - (int)(53 * escala), 
                            (int)(250 * escala), 
                            (int)(50 * escala));
...
/*------------------------DESENHO DOS ELEMENTOS-------------------------------*/
                    ...
                    if (mostrarImagemBotaoFacil) {
                        g2d.drawImage(imagemBotaoFacil,
                                xFacil, 
                                yFacil + 7,
                                larguraBotFacil, 
                                alturaBotFacil, this);
                    ...
                    if (mostrarImagemBotaoMedio) {
                        g2d.drawImage(imagemBotaoMedio,
                                xMedio, 
                                yMedio + 7,
                                larguraBotMedio,
                                alturaBotMedio, this);
                    ...
                    if (mostrarImagemBotaoDificil) {
                        g2d.drawImage(imagemBotaoDificil, 
                                xDificil, 
                                yDificil + 7, 
                                larguraBotDificil, 
                    ...
                    g2d.drawImage(imagemBotaoDificuldade, 
                            xDif,
                            yDif,
                            larguraBotDif, 
                            alturaBotDif, this);
...
/*---------------------CONFIGURAÇÃO DO BOTÃO EDITAR PERGUNTA------------------*/
            ...
            botaoEditarPergunta.addActionListener(e -> {
                TelaEditarPergunta editarPergunta = 
                        new TelaEditarPergunta(idProfessor);
...
/*----------------------CONFIGURAÇÃO DO CAMPO TEXTO PERGUNTA------------------*/
            ...
            campoTextoPergunta.setFont(new Font("Jockey One", 
                    Font.BOLD, 
                    35));
...
/*------------------CONFIGURAÇÃO DO CAMPO NÚMERO DA PERGUNTA------------------*/
            ...
            campoTextoNumeroPergunta.setFont(new Font("Jockey One",
                    Font.BOLD,
                    35));
