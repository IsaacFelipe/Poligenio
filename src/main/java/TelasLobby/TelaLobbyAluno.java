...
public class TelaLobbyAluno extends JFrame {
    ...
    public TelaLobbyAluno(){
        ...
        try {
            PanelLobbyAluno telaLobbyAlunoPanel = new PanelLobbyAluno(painelLobbyAluno);
            PanelCodigo telaCodigoPanel = new PanelCodigo(painelLobbyAluno);
            TelaInicial telaInicial = new TelaInicial("", "", sistema);
            PanelConfiguracao telaConfigPanel = new PanelConfiguracao(cardLayout, 
                    painelLobbyAluno, 
                    painelLobbyAluno, 
                    telaInicial, 
                    sistema);
    ...
    public static class PanelLobbyAluno extends JPanel {
        ...
        public PanelLobbyAluno(JPanel container) throws IOException {
            ...
            botaoJogar.addActionListener(e -> {
                // Encontra o container principal (painelInicial) através da hierarquia
                Container parent = getParent();
                while (parent != null && !(parent.getName() != null && parent.getName().equals("painelInicial"))) {
                    parent = parent.getParent();
                }

                if (parent instanceof JPanel) {
                    CardLayout cl = (CardLayout) parent.getLayout();
                    cl.show(parent, "TelaCodigo");
                } else {
                    JOptionPane.showMessageDialog(this, "Erro: Container principal não encontrado!");
                }
            });
            ...
            // Chama para posicionar inicialmente
            painelConteudo.addComponentListener(new java.awt.event.ComponentAdapter() {
                public void componentResized(java.awt.event.ComponentEvent evt) {
                    ajustarPosicoes.run();
                }
            });
            SwingUtilities.invokeLater(ajustarPosicoes);
        }
